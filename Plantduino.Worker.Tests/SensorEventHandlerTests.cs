...
//            protected TemperatureTelemetry CreateMessage(double temp = 21)
//            {
//                return new TemperatureTelemetry(temp, 1000)
//                {
...
//        {
//            private TemperatureTelemetry _msg;
...
//                    Arg.Is<TemperatureTelemetry>(se => se.Temperature == _msg.Temperature && se.Lux == _msg.Lux));
//            }
//        }
