...
{
    public class ColdPeriodEndHandler : ISystemEventHandler
    {
        ...
        public string Name
        {
            get { return EventTypes.ColdPeriodEnd; }
        }

        public ColdPeriodEndHandler(ITopicSubscriber topicSubscriber)
        {
        ...
        public async Task ReceiveAsync()
        {
            ...
            if (msg != null)
            {
                Trace.TraceInformation("Received ColdPeriodEnd message.");
